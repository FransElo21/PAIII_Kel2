...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="{{ asset('owner/assets/plugins/metismenu/metisMenu.min.css') }}">
  <link href="{{ asset('assets/plugins/fancy-file-uploader/fancy_fileupload.css') }}" rel="stylesheet">
  <link rel="stylesheet" type="text/css" href="{{ asset('owner/assets/plugins/metismenu/mm-vertical.css') }}">
  <link rel="stylesheet" type="text/css" href="{{ asset('owner/assets/plugins/simplebar/css/simplebar.css') }}">
...
<!--plugins-->
<script src="{{ asset('owner/assets/plugins/perfect-scrollbar/js/perfect-scrollbar.js') }}"></script>
<script src="{{ asset('owner/assets/plugins/metismenu/metisMenu.min.js') }}"></script>
<script src="{{ asset('owner/assets/plugins/apexchart/apexcharts.min.js') }}"></script>
<script src="{{ asset('owner/assets/plugins/simplebar/js/simplebar.min.js') }}"></script>
<script src="{{ asset('owner/assets/plugins/peity/jquery.peity.min.js') }}"></script>
<script>
    $(".data-attributes span").peity("donut")
</script>
<script src="{{ asset('owner/assets/js/main.js') }}"></script>
<script src="{{ asset('owner/assets/js/dashboard1.js') }}"></script>
<script>
